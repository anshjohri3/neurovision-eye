...
export default function HeroSection() {
  return (
        <div className="md:flex grid md:flex-cols-2 md:pl-16 py-1 md:py-2 font-sans">
            ...
            >
                <motion.div
                    ...
                    className="flex flex-col w-11/ md:w-2/3 text-center md:text-left text-balance gap-4 mx-auto md:mx-0"
                >
                    <h1 className="text-2xl md:text-5xl leading-snug font-medium mx-auto md:mx-0 text-[#FFFFFF]">
                        <Typewriter
                            words={["AI POWERED SYSTEM,", "EARLY EYE DIAGNOSIS "]}
                            loop={true}
                            cursor
                            cursorStyle="|"
                            typeSpeed={200}
            ...
            <Image
                ...
                width={1200} 
                height={100}
                className="hidden md:block md:max-h-[80vh]"
            />
        </div>
