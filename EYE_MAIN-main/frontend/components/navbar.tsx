...
export default function Navbar() {
  ...
  return (
    <nav className="block top-10 w-full py-6 md:py-5 px-10 md:px-50">
      <div className="flex items-center justify-between md:mx-auto">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="flex flex-col md:flex-row gap-1 md:gap-10 text-xl md:text-1xl text-[#858585] text-right font-sans font-light"
        >
          <motion.div
            variants={{
